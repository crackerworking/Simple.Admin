 ...
 */
const axValids=[];class axValid{constructor(e,t,i){if(this.targetDom=axIdToDom(e),!this.targetDom.getAttribute("name"))return console.error("The element to be verified must have a name attribute!"),!1;if(i?this.parent="string"==typeof e?document.querySelector(i):i:this.targetDom.closest("form")?this.parent=this.targetDom.closest("form"):this.parent="",this.options=axExtend({mode:"newLine",iconShow:!0,type:"",rule:{},label:"",within:"",error:"",success:"通过验证！",equal:"",max:"",min:"",divisor:"",length:"",maxLength:"",minLength:"",include:[],exclude:[],earliest:"",latest:"",compare:"",date:"",format:"",inputSuccess:"ax-check-primary",inputError:"ax-check-danger",boxSuccess:"ax-color-primary",boxError:"ax-color-danger",chars:"~!@#",charsShow:!1,trigger:"blur",group:!1,onChange:""},t,this.targetDom),this.handlers={},this.strong=0,this.message="",this.name=this.targetDom.getAttribute("name"),this.buttonId=this.name,this.targetDom.getAttribute("axValid")?this.alias=this.targetDom.getAttribute("axValid"):this.alias="",axIsEmpty(this.options.include)?this.options.include=[]:this.options.include=this.options.include.split(","),axIsEmpty(this.options.exclude)?this.options.exclude=[]:this.options.exclude=this.options.exclude.split(","),this.options.type.indexOf("strong")>-1&&this.options.format){this.upperLen="",this.lowerLen="",this.numberLen="",this.charLen;let e="",t="",i="";if(this.formatMin="",this.formatMax="",this.onlyName={},this.lowerName="",this.upperName="",this.numberName="",this.charsName="",this.scaleNameGroup=[],this.scaleName={},this.scale="",this.regExp="",this.regText=[],e=this.options.format.split("#")[0],this.options.format.split("#")[1]?(t=this.options.format.split("#")[1],this.formatMin=t.split(",")[0],-1==t.indexOf(",")?(this.lengthOnly=!0,this.formatMax=""):-1!==t.indexOf(",")&&t.split(",")[1]?this.formatMax=t.split(",")[1]:this.formatMax=""):(this.formatMin="",this.formatMax=""),this.options.format.split("#")[2]&&(i=this.options.format.split("#")[2],-1!==i.indexOf("a")&&(this.scaleName.lower="小写字母",this.scale+="a-z",this.regText.push("a-z"),this.scaleNameGroup.push(this.scaleName.lower)),-1!==i.indexOf("A")&&(this.scaleName.upper="大写字母",this.scale+="A-Z",this.regText.push("A-Z"),this.scaleNameGroup.push(this.scaleName.upper)),-1!==i.indexOf("9")&&(this.scaleName.number="数字",this.scale+="0-9",this.regText.push("0-9"),this.scaleNameGroup.push(this.scaleName.number)),-1!==i.indexOf("~")&&(this.scaleName.char=this.options.charsShow?'特殊字符"'+this.options.chars+'"':"特殊字符",this.scale+=this.options.chars,this.regText.push(this.options.chars),this.scaleNameGroup.push(this.scaleName.char)),-1!==i.indexOf("中")&&(this.scaleName.cn="中文",this.scale+="一-龥",this.regText.push("一-龥"),this.scaleNameGroup.push(this.scaleName.cn)),this.scaleNameGroup.length>2?this.scaleNameGroup=axRangeReplace(this.scaleNameGroup.join(),"和",this.scaleNameGroup.join().lastIndexOf(","),"",1):this.scaleNameGroup=this.scaleNameGroup.join(),this.scaleNameGroup=this.scaleNameGroup.replaceAll(",","、"),!axIsEmpty(this.scaleNameGroup)&&(this.message+="必须是"+this.scaleNameGroup+"，并且要求")),axIsEmpty(this.options.format.split("#")[0])&&this.options.format.split("#")[3]&&(this.options.format.split("#")[3]<i.length&&this.options.format.split("#")[3]>0?2==this.options.format.split("#")[3]?this.regText.forEach(e=>{this.regExp+="(?!["+e+"]+$)"}):3==this.options.format.split("#")[3]?axArrange(this.regText,2).forEach(e=>{this.regExp+="(?!["+e.join().replaceAll(",","")+"]+$)"}):4==this.options.format.split("#")[3]&&axArrange(this.regExp,3).forEach(e=>{this.regExp+="(?!["+e.join().replaceAll(",","")+"]+$)"}):console.error("随机字符类型必须有1种，并且不能超过允许字符类型范围！"),this.message=this.scaleNameGroup+"中至少选择"+this.options.format.split("#")[3]+"种字符。"),-1!==e.indexOf("a")){let t=e.lastIndexOf("a");this.onlyName.lower="小写字母",this.lowerLen=parseInt(e.substring(t+1,t+2)),this.message+=this.onlyName.lower+"至少"+this.lowerLen+"个，"}if(-1!==e.indexOf("A")){let t=e.lastIndexOf("A");this.onlyName.upper="大写字母",this.upperLen=parseInt(e.substring(t+1,t+2)),this.message+=this.onlyName.upper+"至少"+this.upperLen+"个，"}if(-1!==e.indexOf("9")){let t=e.lastIndexOf("9");this.onlyName.number="数字",this.numberLen=parseInt(e.substring(t+1,t+2)),this.message+=this.onlyName.number+"至少"+this.numberLen+"个，"}if(-1!==e.indexOf("~")){let t=e.lastIndexOf("~");this.onlyName.char=this.options.charsShow?'特殊字符"'+this.options.chars+'"':"特殊字符",this.charLen=parseInt(e.substring(t+1,t+2)),this.message+=this.onlyName.char+"至少"+this.charLen+"个。"}if(-1!==e.indexOf("中")){let t=e.lastIndexOf("中");this.onlyName.cn="中文",this.cnLen=parseInt(e.substring(t+1,t+2)),this.message+=this.onlyName.cn+"至少"+this.cnLen+"个。"}this.lowerLen&&(this.regExp+="(?="+Array(this.lowerLen+1).join(".*?[a-z]")+")"),this.upperLen&&(this.regExp+="(?="+Array(this.upperLen+1).join(".*?[A-Z]")+")"),this.numberLen&&(this.regExp+="(?="+Array(this.numberLen+1).join(".*?[0-9]")+")"),this.charLen&&(this.regExp+="(?="+Array(this.charLen+1).join(".*?["+this.options.chars+"]")+")"),this.cnLen&&(this.regExp+="(?="+Array(this.cnLen+1).join(".*?[一-龥]")+")"),axIsEmpty(this.scale)?axIsEmpty(this.scale)&&this.formatMin?this.regExp+=".":this.regExp+=".{0,}":this.formatMin?this.regExp+="["+this.scale+"]":this.regExp+="["+this.scale+"]+",this.formatMin&&this.lengthOnly&&!this.formatMax?(this.regExp+="{"+this.formatMin+"}",this.message+="总共只能是"+this.formatMin+"个字符。"):this.formatMin&&!this.formatMax?(this.regExp+="{"+this.formatMin+",}",this.message+="总共至少"+this.formatMin+"个字符。"):this.formatMin&&this.formatMax&&(this.regExp+="{"+this.formatMin+","+this.formatMax+"}",this.message+="总共至少"+this.formatMin+"个字符，且不能超过"+this.formatMax+"个字符。")}this.init()}init(){let e=this;this.buttonId&&(axIsEmpty(axValids)?axValids.push({name:this.buttonId,alias:this.alias,instance:this,parent:this.parent}):axValids.some(e=>e.name==this.buttonId&&e.parent==this.parent)||axValids.push({name:this.buttonId,alias:this.alias,instance:this,parent:this.parent})),axValids.some(e=>e.name==this.options.compare)?(this.compareName=axInstance(axValids,this.options.compare).name,axInstance(axValids,this.options.compare).options.label?this.compareLabel=axInstance(axValids,this.options.compare).options.label:this.compareLabel=this.compareName):this.options.compare&&document.querySelector("[name = "+this.options.compare+"]")?(this.compareName=this.options.compare,this.compareLabel=this.options.compare):(this.compareLabel="",this.compareName=""),this.rules=this.getRules(this.options.rule,this.options.label),this.msgBox=axAddElem("div",{valid:""}),"submit"==this.options.trigger?this.targetDom.addEventListener("change",()=>{e.createMsg()},!1):"input"==this.options.trigger?this.targetDom.addEventListener("input",()=>{e.createMsg()},!1):"change"==this.options.trigger?this.targetDom.addEventListener("change",()=>{e.createMsg()},!1):this.targetDom.addEventListener("blur",()=>{e.createMsg()},!1)}getRules(e,t){if("string"==typeof e&&e)e=JSON.parse(e);else{this.options.type.trim().split(",").forEach(i=>{this.isType(i,e,t)})}return e}isType(e,t,i){"isRequired"==e?t.presence={message:this.diyMsg("^"+i+"不能为空！")}:"isEmail"==e?t.email={message:this.diyMsg('^"%{value}"不是一个有效的邮箱地址！')}:"isUrl"==e?t.url={message:this.diyMsg('^"%{value}"不是一个有效的网址！')}:"exclude"==e?this.options.exclude&&(t.exclusion={within:this.options.exclude,message:this.diyMsg("^"+i+'"%{value}"是不被允许的！')}):"include"==e?this.options.include&&(t.inclusion={within:this.options.include,message:this.diyMsg("^"+i+'"%{value}"是不被允许的！')}):"maxLength"==e?this.options.maxLength&&(axIsEmpty(t.length)&&(t.length={}),t.length.maximum=this.options.maxLength,t.length.tooLong=this.diyMsg("^"+i+"最多允许"+this.options.maxLength+"个字符串！")):"minLength"==e?this.options.minLength&&(axIsEmpty(t.length)&&(t.length={}),t.length.minimum=this.options.minLength,t.length.tooShort=this.diyMsg("^"+i+"最少要求"+this.options.minLength+"个字符串！")):"length"==e?this.options.length&&(axIsEmpty(t.length)&&(t.length={}),t.length.is=this.options.length,t.length.wrongLength=this.diyMsg("^"+i+"要求等于"+this.options.length+"个字符串！")):"isStrict"==e?(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.strict=!0,t.numericality.notValid=this.diyMsg("^"+i+"要求是一个数字并且不能以0开头！")):"isNumber"==e?(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.notValid=this.diyMsg("^"+i+"必须是一个数字！")):"isOdd"==e?(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.odd=!0,t.numericality.notOdd=this.diyMsg("^"+i+"要求是一个奇数！")):"isEven"==e?(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.even=!0,t.numericality.notEven=this.diyMsg("^"+i+"要求是一个偶数！")):"isInteger"==e?(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.onlyInteger=!0,t.numericality.notInteger=this.diyMsg("^"+i+"要求是一个整数！")):"greaterThan"==e?this.options.max&&(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.greaterThan=this.options.max,t.numericality.notGreaterThan=this.diyMsg("^"+i+"要求大于"+this.options.max+"！")):"greaterEqual"==e?this.options.max&&(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.greaterThanOrEqualTo=this.options.max,t.numericality.notGreaterThanOrEqualTo=this.diyMsg("^"+i+"要求大于或等于"+this.options.max+"！")):"lessThan"==e?this.options.min&&(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.lessThan=this.options.min,t.numericality.message=this.diyMsg("^"+i+"要求小于"+this.options.min+"！")):"lessEqual"==e?this.options.min&&(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.lessThanOrEqualTo=this.options.min,t.numericality.notLessThanOrEqualTo=this.diyMsg("^"+i+"要求小于或等于"+this.options.min+"！")):"equal"==e?this.options.equal&&(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.equalTo=this.options.equal,t.numericality.notEqualTo=this.diyMsg("^"+i+"要求等于"+this.options.equal+"！")):"divisible"==e?this.options.divisor&&(axIsEmpty(t.numericality)&&(t.numericality={}),t.numericality.divisibleBy=this.options.divisor,t.numericality.notDivisibleBy=this.diyMsg("^"+i+"要求能被"+this.options.divisor+"整除！")):"isDateTime"==e?(axIsEmpty(t.datetime)&&(t.datetime={}),t.datetime.notValid=this.diyMsg('^"%{value}"不是一个日期格式！')):"isDate"==e?(axIsEmpty(t.datetime)&&(t.datetime={}),t.datetime.dateOnly=!0,t.datetime.notValid=this.diyMsg('^"%{value}"不是一个日期格式！正确格式如：2021-2-12或2021/2/12')):"earliest"==e?this.options.earliest&&(axIsEmpty(t.datetime)&&(t.datetime={}),t.datetime.earliest=this.options.earliest,t.datetime.tooEarly=this.diyMsg("^日期时间不能早于"+this.options.earliest+"！")):"latest"==e?this.options.latest&&(axIsEmpty(t.datetime)&&(t.datetime={}),t.datetime.latest=this.options.latest,t.datetime.tooLate=this.diyMsg("^日期时间不能晚于"+this.options.latest+"！")):"confirm"==e?axIsEmpty(this.options.compare)||(t.equality={attribute:this.options.compare,message:this.diyMsg("^"+i+"与"+this.compareLabel+"不一致！")}):"strong"==e&&this.options.format&&(t.format={pattern:this.regExp,message:this.diyMsg("^"+i+"要求"+this.message)})}diyMsg(e){return this.options.error?this.options.error:e}createMsg(){let e={},t={},i=this.targetDom.name,s=this.targetDom.value;if(!s||(e[i]=s),this.compareName&&this.options.compare){let t=document.querySelector("[name="+this.compareName+"]").value;e[this.compareName]=t}!this.rules||(t[i]=this.rules),validate.extend(validate.validators.datetime,{parse:(e,t)=>(this.timeValue=e,axLocalTime(e)),format:(e,t)=>this.timeValue});let n=validate(e,t,{format:"flat"});n?(this.flag=!1,this.result=n[0],this.targetDom.classList.remove(this.options.inputSuccess),this.targetDom.classList.add(this.options.inputError),this.msgBox.classList.remove(this.options.boxSuccess),this.msgBox.classList.add(this.options.boxError),this.options.iconShow?this.msgBox.innerHTML=axIcon.font.errorFill+" "+this.result:this.msgBox.innerHTML=this.result):(this.flag=!0,this.result=this.options.label+this.options.success,this.targetDom.classList.remove(this.options.inputError),this.targetDom.classList.add(this.options.inputSuccess),this.msgBox.classList.remove(this.options.boxError),this.msgBox.classList.add(this.options.boxSuccess),this.options.iconShow?this.msgBox.innerHTML=axIcon.font.successFill+" "+this.result:this.msgBox.innerHTML=this.result);let a=0,o=0,r=0,l=0,c=0,d=0;if("strong"==this.options.type&&this.options.format&&(s&&s.match(new RegExp("[a-z]"))&&(o=1),s&&s.match(new RegExp("[A-Z]"))&&(a=1),s&&s.match(new RegExp("[0-9]"))&&(r=1),s&&s.match(new RegExp("["+this.options.chars+"]"))&&(l=1),s&&s.match(new RegExp("[一-龥]"))&&(c=1),s&&this.formatMin&&s.length>=this.formatMin&&(d=1)),this.strong=a+o+r+l+c+d,axValids.find(e=>e.name=this.buttonId&&e.parent==this.parent).instance=this,"note"==this.options.mode){this.msgBox.classList.add("ax-form-txt");let e=this.targetDom.parentNode.parentNode.nextElementSibling;e&&e.hasAttribute("valid")&&(e.remove(),this.targetDom.parentNode.parentNode.insertAdjacentElement("afterend",this.msgBox)),this.targetDom.parentNode.parentNode.insertAdjacentElement("afterend",this.msgBox)}else if("popup"==this.options.mode)this.popup?(this.popup.content.innerHTML="",this.popup.content.appendChild(this.msgBox)):this.popup=new axPopup(this.targetDom,{content:this.msgBox,padding:!1,placement:"bottom-start",offsetShow:!1,arrow:!1,close:!1,footerShow:!1,theme:"crude",stay:!0}).show();else if("message"==this.options.mode)this.flag?new axMessage({content:this.result,result:"success",iconShow:!0}):new axMessage({content:this.result,result:"error",iconShow:!0});else if("#"==this.options.mode.substr(0,1))document.querySelector(this.options.mode).innerHTML="",this.options.group?axIsEmpty(axValids)||axValids.forEach(e=>{axIsEmpty(e.instance.msgBox.children)||document.querySelector(this.options.mode).insertAdjacentElement("beforeend",e.instance.msgBox)}):document.querySelector(this.options.mode).appendChild(this.msgBox);else if(1==this.options.mode.nodeType)this.options.mode.innerHTML="",this.options.group?axIsEmpty(axValids)||axValids.forEach(e=>{axIsEmpty(e.instance.msgBox.children)||document.querySelector(this.options.mode).insertAdjacentElement("beforeend",e.instance.msgBox)}):this.options.mode.appendChild(this.msgBox);else{this.msgBox.classList.add("ax-valid");let e=this.targetDom.nextElementSibling;e&&e.hasAttribute("valid")&&e.remove(),this.targetDom.insertAdjacentElement("afterend",this.msgBox)}this.options.onChange&&this.options.onChange.call(this,this.strong,this.flag,this.msgBox.innerHTML),"update"in this.handlers&&this.emit("update",this.strong,this.flag,this.msgBox.innerHTML)}on(e,t){return axAddPlan(e,t,this),this}emit(e,...t){axExePlan(e,this,...t)}off(e,t){return axDelPlan(e,t,this),this}}[...document.querySelectorAll("[axValid]")].filter(e=>e.getAttribute("name")).forEach(e=>{new axValid(e)});
/*!
